<%-- 
    Document   : restaurant
    Created on : 8 thg 6, 2024, 15:50:53
    Author     : admin
--%>
...
<html>
    <head>
        ...
        <!-- Template Stylesheet -->
        <link href="../bootstrap/css/style_1.css" rel="stylesheet">
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <div style="padding: 13px 20px"><a href="" style="padding: 20px 15px"  class="btn btn-primary py-2 px-4 w-15 h-1">Book A Table</a></div> 
            ...
            <div class="container my-5 py-5">
                <div class="row align-items-center g-5">
                    ...
                    <div class="col-lg-6 text-center text-lg-end overflow-hidden">
                        <img class="img-fluid" src="../bootstrap/images/hero.png" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Template Javascript -->
        <script src="../bootstrap/js/main_1.js"></script>
    </body>
</html>
