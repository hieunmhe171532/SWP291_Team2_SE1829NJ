            ...
            <div class="container">
                <div class="row no-gutters">
                    <div class="col-md-7 order-md-last d-flex">
                        <div class="img img-1 mr-md-2 ftco-animate" style="background-image: url(${blog.image});"></div>
                    ...
                    <div class="col-md-5 wrap-about pb-md-3 ftco-animate pr-md-5 pb-md-5 pt-md-4">
                        ...
                        <p>${blog.briefinfo}</p>
                        <p><a href="listroomforcus" class="btn btn-secondary rounded">Reserve Your Room Now</a></p>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-md-7 py-5 pl-md-5">
                        <div class="py-md-5">
                            ...
                            <div class="carousel-testimony owl-carousel ftco-animate">
                                <c:forEach items="${listfbt}" var="fb" >
                                    <div class="item">
                                        <div class="testimony-wrap pb-4">
                                            <div class="text">
                                                <p class="mb-4">${fb.description}</p>
                                            </div>
                                            <div class="d-flex">
                                                <div class="user-img" hidden="" style="background-image: url(bootstrap/images/person_1.jpg)">
                                                </div>
                                                <div class="pos ml-3">
                                                    <p class="name">${fb.acc.getUsername()}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
