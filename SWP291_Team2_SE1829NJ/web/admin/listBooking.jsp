        ...
        <div class="tile">
            <div class="tile-body">
                ...
                <ul class="nav nav-tabs" id="orderTabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="order-today-tab" data-toggle="tab" href="#orderToday" role="tab" aria-controls="orderToday" aria-selected="true">Order Today</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="all-order-tab" data-toggle="tab" href="#allOrder" role="tab" aria-controls="allOrder" aria-selected="false">All Orders</a>
                    </li>
                </ul>
                <div class="tab-content" id="orderTabsContent">
                    <div class="tab-pane fade show active" id="orderToday" role="tabpanel" aria-labelledby="order-today-tab">
                        <table class="table table-hover table-bordered js-copytextarea" id="orderTodayTable">
                            <thead>
                                <tr>
                                    <th>No.BookId</th>
                                    <th>Order ID</th>
                    ...
                    <div class="tab-pane fade" id="allOrder" role="tabpanel" aria-labelledby="all-order-tab">
                        <table class="table table-hover table-bordered js-copytextarea" id="allOrderTable">
                            <thead>
                                <tr>
                                    <th>No.BookId</th>
                                    <th>Order ID</th>
